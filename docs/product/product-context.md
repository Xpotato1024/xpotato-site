...
1. MDX を作る。
2. 最小限の frontmatter を埋める。
3. 必要な画像を ingest する。
4. Markdown / approved content module で本文を書く。
5. validation を通す。
6. PR merge 後に static build / deploy される。
...
### G6. Maximum practical delivery optimization
