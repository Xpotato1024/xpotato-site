...
- vNext production deploy artifact determinism (ADR-0032): **ACCEPTED 2026-09-24**。Exact reviewed/audited candidate `7686abd360c46775c4e9fbef7e3209af8ba43c63`（fresh audit P0=0/P1=0/P2=0）で、Astro 7.2.7のcheckout-path-dependent UIDをfinal distのbounded canonicalizationで除き、UTF-8 bytewise sorted manifestとbinary-framed tree SHA256を導入する。Windows別absolute pathとHosted Linuxでfinal 32/32 bytesおよび`outputTreeSha256=8c2e1b5f00fa3caabc7403e9cb9f930ef157fa66f5d88bee7a3f3c973fadb252`が一致。ADR-0030のlegacy equivalenceは拡張しない。Windows full `npm run ci`のPhase 6 media processing論理差は別件で未解消。Acceptance/main mergeはprovider mutation・JIT token・production deployを認可せず、production operationは別途explicit authorizationを要する。
- Adoption records: `../design/amendment-acceptance-2026-08-29.md`, `../design/amendment-acceptance-adr-0030-2026-08-29.md`, `../design/amendment-acceptance-adr-0031-2026-09-04.md`, and `../design/amendment-acceptance-adr-0032-2026-09-24.md`。
