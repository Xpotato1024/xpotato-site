...
if (process.argv.includes("--write")) {
  ...
  if (sourceArtifact !== expected) errors.push("apps/site/public/_headers is stale for the current production build");
  if (builtArtifact !== expected) errors.push("apps/site/dist/_headers is stale for the current production build");
